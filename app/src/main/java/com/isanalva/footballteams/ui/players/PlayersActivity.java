...
public class PlayersActivity extends AppCompatActivity implements PlayersView, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        teamName = getIntent().getStringExtra(FootballTeamsConsts.INTENT_TEAM_PARAM);
        ...
        recycler = (RecyclerView) findViewById(R.id.players_recycler_view);
        ...
        presenter = new PlayersPresenterImpl(teamName,this);
    }
    ...
    @Override
    public void setPlayers(List<TeamPlayer> items) {
        adapter = new PlayersAdapter(this,items,teamName);
        recycler.setAdapter(adapter);
    }
